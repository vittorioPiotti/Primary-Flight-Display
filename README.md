...
|  \[
   ...
   \]| Distanza euclidea tra due punti in un piano cartesiano | Utilizzato per calcolare la lunghezza del segmento che collega due punti | 
| \[
   y = y_0 + m(x - x_0)
   \]| Equazione del fascio di rette passante per un punto | Utilizzato per calcolare l’equazione della retta dell’orizzonte | 
